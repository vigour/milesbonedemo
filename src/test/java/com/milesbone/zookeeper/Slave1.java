...
public class Slave1 implements Watcher {
	...
	public void createTemp() throws Exception {
		...
		zk.create("/a/b", "b".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);

		logger.info("b创建子节点成功...........");
...
logger.info("data:{}", data);
			if (data.equals("b")) {// 等于本身就启动作为Master
...
logger.info("temp:{}", temp);					
	...
	public static void main(String[] args) throws Exception {
		...
		Slave1 s = new Slave1("192.168.4.128:2181,192.168.4.128:2182,192.168.4.128:2183");
